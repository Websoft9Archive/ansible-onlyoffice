...
对 OnyOffice Document Server 来说，本项目采用的是 Docker 镜像安装官，即每一次安装均可保证为 ONLYOFFICE 官方发布的最新稳定版。
...
```
wget -N https://raw.githubusercontent.com/Websoft9/linux/master/ansible_script/install.sh ; bash install.sh repository=onlyoffice
```
